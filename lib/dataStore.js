...
async function seedDemo() {
  ...
  if (!Array.isArray(demoTemplateData.layoutNodes) || demoTemplateData.layoutNodes.length === 0) {
    const error = new Error('The demo template has no saved canvas layout. Save the template before copying it to the demo operation.');
    error.code = 'DEMO_LAYOUT_NOT_SAVED';
    throw error;
  }
...
export { readData, writeData, ensureInitialized, ensureSchema, resetDatabase, seedEssential, seedDemo, copyTemplateToDemo };
